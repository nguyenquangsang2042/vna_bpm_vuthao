...
{
    public class TemplateValueType_ControlDate : ControlDate
    {
        ...
        public TemplateValueType_ControlDate(Activity _mainAct, LinearLayout _parentView, ViewElement _elementParent, ViewElement _elementChild, JObject _JObjectChild, int _flagView) : base(_mainAct, _parentView, _elementChild)
        {
