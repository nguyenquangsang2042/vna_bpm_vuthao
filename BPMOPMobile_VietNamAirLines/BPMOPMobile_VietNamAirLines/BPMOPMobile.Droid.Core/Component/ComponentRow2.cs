...
{
    public class ComponentRow2 : ComponentBase
    {
        ...
        public ComponentRow2(Activity _mainAct, LinearLayout _parentView, ViewRow _controlData, int _widthScreenTablet, bool _visibleItemLine,int _flagView)
        {
        ...
        {
            row1 = new ComponentRow1(_mainAct, _parentView, _controlData.Elements[0], (int)_widthScreenTablet / 2, _visibleItemLine, _flagView);
            row2 = new ComponentRow1(_mainAct, _parentView, _controlData.Elements[1], (int)_widthScreenTablet / 2, _visibleItemLine, _flagView);
        }
        ...
        public override void InitializeFrameView(LinearLayout frame)
        {
            ...
            if (_widthScreenTablet == -1) // ForPhone
            {
                ...
                _widthRow = dm.WidthPixels / 2;
            }
            else // For Tablet
            {
                _widthRow = _widthScreenTablet / 2;
            }
