...
{
    class ControlMultiLookup : ControlBase
    {
        ...
        public override string Value
        {
            set
            {
                if (!String.IsNullOrEmpty(_element.Value))
                {
                    ...
                    string _result = "";
                    List<string> _lstValue = CmmFunction.GetNameFromLookupData(_data);
        ...
        public ControlMultiLookup(Activity _mainAct, LinearLayout _parentView, ViewElement _element) : base(_mainAct)
        {
        ...
        public ControlMultiLookup(Activity _mainAct, LinearLayout _parentView, ViewElement _elementParent, ViewElement _elementChild, JObject _JObjectChild, int _flagView) : base(_mainAct)
        {
            // Để render theo base
            this._parentView = _parentView;
