...
{
    public class TemplateValueType_ControlNumber : ControlNumber
    {
        ...
        public TemplateValueType_ControlNumber(Activity _mainAct, LinearLayout _parentView, ViewElement _elementParent, ViewElement _elementChild, JObject _JObjectChild, int _flagView) : base(_mainAct, _parentView, _elementChild)
        {
