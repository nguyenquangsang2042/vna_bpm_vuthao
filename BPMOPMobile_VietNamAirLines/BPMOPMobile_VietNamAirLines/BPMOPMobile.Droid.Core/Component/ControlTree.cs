...
{
    public class ControlTree : ControlBase
    {
        ...
        public override string Value
        {
            set
            {
                ...
                string _result;
                if (_data.Contains(";#"))
                    _result = _data.Split(new string[] { ";#" }, StringSplitOptions.None)[1];
                else
                    _result = _data;
        ...
        public ControlTree(Activity _mainAct, LinearLayout _parentView, ViewElement _element) : base(_mainAct)
        {
