...
{
	[Register ("ListUserOrGroupView")]
	partial class ListUserOrGroupView
	{
		[Outlet]
		...
		[Outlet]
		[GeneratedCode ("iOS Designer", "1.0")]
		UIKit.UILabel lbl_lineSearchUser { get; set; }
		...
		void ReleaseDesignerOutlets ()
		{
			...
			if (lbl_lineSearchUser != null) {
				lbl_lineSearchUser.Dispose ();
				lbl_lineSearchUser = null;
			}
