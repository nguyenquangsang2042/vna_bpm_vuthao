    ...
    public class Custom_DuedateCategory : UIView
    {
        ...
        public void CallBackupData()
        {
            if (viewController.GetType() == typeof(MainView))
            {
                ...
                {
                    mainView.lst_dueDateMenu_toMe = ExtensionCopy.CopyAll(ListClassMenuBK);
                    mainView.DuedateSelected_toMe = ExtensionCopy.CopyAll(ClassMenu_selectedBK);
                }
                else
                {
                    mainView.lst_dueDateMenu_fromMe = ExtensionCopy.CopyAll(ListClassMenuBK);
                    mainView.DuedateSelected_fromMe = ExtensionCopy.CopyAll(ClassMenu_selectedBK);
                }
            }
            else if (viewController.GetType() == typeof(MyRequestListView))
            {
                ...
                myRequestListView.lst_dueDateMenu_fromMe = ExtensionCopy.CopyAll(ListClassMenuBK);
                myRequestListView.DuedateSelected_fromMe = ExtensionCopy.CopyAll(ClassMenu_selectedBK);
            }
            else if (viewController.GetType() == typeof(RequestListView))
            {
                RequestListView requestListView = viewController as RequestListView;
                requestListView.lst_dueDateMenu_toMe = ExtensionCopy.CopyAll(ListClassMenuBK);
                requestListView.DuedateSelected_toMe = ExtensionCopy.CopyAll(ClassMenu_selectedBK);
            }
            //app
            ...
            //    {
            //        mainViewApp.lst_dueDateMenu_toMe = ExtensionCopy.CopyAll(ListClassMenuBK);
            //        mainViewApp.DuedateSelected_toMe = ExtensionCopy.CopyAll(ClassMenu_selectedBK);
            //    }
            //    else
            //    {
            //        mainViewApp.lst_dueDateMenu_fromMe = ExtensionCopy.CopyAll(ListClassMenuBK);
            //        mainViewApp.DuedateSelected_fromMe = ExtensionCopy.CopyAll(ClassMenu_selectedBK);
            //    }
            //}
            ...
            //    myRequestListViewApp.lst_dueDateMenu_fromMe = ExtensionCopy.CopyAll(ListClassMenuBK);
            //    myRequestListViewApp.DuedateSelected_fromMe = ExtensionCopy.CopyAll(ClassMenu_selectedBK);
            //}
            ...
            //    requestListViewApp.lst_dueDateMenu_toMe = ExtensionCopy.CopyAll(ListClassMenuBK);
            //    requestListViewApp.DuedateSelected_toMe = ExtensionCopy.CopyAll(ClassMenu_selectedBK);
            //}
        ...
        private void HandleItemSelect(ClassMenu _menu)
        {
            ...
            {
                if (viewController is MainView)
                    (viewController as MainView).isBackFromFilter = true;
                else if (viewController is RequestListView)
                    (viewController as RequestListView).isBackFromFilter = true;
                else if (viewController is MyRequestListView)
                    (viewController as MyRequestListView).isBackFromFilter = true;
            }
        ...
        private void CloseInstance()
        {
            ...
            {
                MainView mainView = viewController as MainView;
                mainView.CloseDueDateCateInstance();
            }
            else if (viewController.GetType() == typeof(MyRequestListView))
            {
                MyRequestListView myRequestListView = viewController as MyRequestListView;
                myRequestListView.CloseDueDateCateInstance();
            }
            else if (viewController.GetType() == typeof(RequestListView))
            {
                RequestListView requestListView = viewController as RequestListView;
                requestListView.CloseDueDateCateInstance();
            }
            //app
            //else if (viewController.GetType() == typeof(MainViewApp))
            //{
            //    MainViewApp mainViewApp = viewController as MainViewApp;
            //    mainViewApp.CloseDueDateCateInstance();
            //}
            //else if (viewController.GetType() == typeof(MyRequestListViewApp))
            //{
            //    MyRequestListViewApp myRequestListViewApp = viewController as MyRequestListViewApp;
            //    myRequestListViewApp.CloseDueDateCateInstance();
            //}
            //else if (viewController.GetType() == typeof(RequestListViewApp))
            //{
            //    RequestListViewApp requestListViewApp = viewController as RequestListViewApp;
            //    requestListViewApp.CloseDueDateCateInstance();
            //}
        ...
        private void BT_clear_TouchUpInside(object sender, EventArgs e)
        {
            ...
            if (viewController.GetType() == typeof(MainView))
            {
                ...
                if (parent.tab_toMe)
                    parent.DuedateSelected_toMe = ClassMenu_selected;
                else
                    parent.DuedateSelected_fromMe = ClassMenu_selected;
            }
