    ...
    public class Custom_ValueDetailsCell : UITableViewCell
    {
        ...
        private void LoadData()
        {
            try
            {
                ...
                collectionRow.Delegate = new CustomFlowLayoutDelegate(this);
        ...
        {
            base.LayoutSubviews();
            collectionRow.Frame = new CGRect(0, 0, ContentView.Frame.Width, 60);
        }
        ...
        {
            public static NSString CellID = new NSString("packageCellID" + CmmIOSFunction.a.ToString());
            ...
            public void UpdateRow(BeanWFDetailLookup _data, Custom_ValueDetailsCell _parentView, int _rowIndex, bool _isFirst, bool _isodd, bool isRowSum)
            {
                try
                {
                    ...
                    else if (_data.DataType == "selectusergroup" || _data.DataType == "selectusergroupmulti")
                    {
                    ...
                    else if (_data.DataType == "selectuser" || _data.DataType == "selectusermulti")
                    {
                        var data = _data.DataValue.ToString().Trim();
                        string result;
                        if (data.Contains(";#"))
            ...
            public override void LayoutSubviews()
            {
                ...
                lbl_name.Frame = new CGRect(10, 5, ContentView.Frame.Width - 10, 40);
            }
        }
        private class CustomFlowLayoutDelegate : UICollectionViewDelegateFlowLayout
        {
            ...
            #region Constructors
            public CustomFlowLayoutDelegate(Custom_ValueDetailsCell _parent)
            {
                parentView = _parent;
            }
            #endregion
            ...
            public override CGSize GetSizeForItem(UICollectionView collectionView, UICollectionViewLayout layout, NSIndexPath indexPath)
            {
                ...
                return new CGSize(res.EstWidth, 50);
            }
