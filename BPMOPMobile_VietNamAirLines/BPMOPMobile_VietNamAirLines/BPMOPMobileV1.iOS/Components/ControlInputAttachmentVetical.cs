    ...
    class ControlInputAttachmentVetical: ControlBase
    {
        ...
        private class Attachment_cell_custom : UITableViewCell
        {
            ...
            private void viewConfiguration()
            {
                ...
                btn_remove.SetImage(UIImage.FromFile("Icons/icon_close_red.png"), UIControlState.Normal);
            ...
            public override void LayoutSubviews()
            {
                ...
                const int paddingTop = 10;
                const int paddingLeft = 25;
                var width = ContentView.Frame.Width - 30;

                btn_remove.Frame = new CGRect(ContentView.Frame.Width - 30, 15, 30, 30);

                iv_type.Frame = new CGRect(paddingLeft, paddingTop, 20, 20);
