...
namespace BPMOPMobile.iPad.CustomControlClass
{
    class Custom_WorkflowCategory : UIView
    {
        ...
        private Custom_WorkflowCategory()
        {
            ...
            table_menu.SeparatorStyle = UITableViewCellSeparatorStyle.SingleLine;
        ...
        private class MenuOption_Cell_Custom : UITableViewCell
        {
            ...
            public void loadData()
            {
                try
                {
                    ...
                    if (menu.IsSelected)
                    {
                        lbl_name.TextColor = UIColor.FromRGB(0, 95, 212);
            ...
            public override void LayoutSubviews()
            {
                ...
                else
                {
                    ...
                    NSLayoutConstraint.Create(this.iv_icon, NSLayoutAttribute.Right, NSLayoutRelation.Equal, this, NSLayoutAttribute.Right, 1.0f, -20.0f).Active = true;
                    ...
                    NSLayoutConstraint.Create(this.lbl_name, NSLayoutAttribute.Right, NSLayoutRelation.Equal, this, NSLayoutAttribute.Right, 1.0f, 30.0f).Active = true;
                    NSLayoutConstraint.Create(this.lbl_name, NSLayoutAttribute.CenterY, NSLayoutRelation.Equal, this, NSLayoutAttribute.CenterY, 1.0f, 0.0f).Active = true;
                }
            }
        }
