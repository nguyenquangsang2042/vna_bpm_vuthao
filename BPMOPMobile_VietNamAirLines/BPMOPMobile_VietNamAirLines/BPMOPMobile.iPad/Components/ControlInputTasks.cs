...
namespace BPMOPMobile.iPad.Components
{
    public class ControlInputTasks : ControlBase
    {
        ...
        List<BeanTask> lst_task = new List<BeanTask>();
        UIView view_header;
        ...
        public ControlInputTasks(UIViewController _parentView, ViewElement _element, NSIndexPath _indexPath)
        {
            ...
            else if (parentView.GetType() == typeof(FollowListViewController))
            {
                ...
                currentWorkFlowItemID = followListViewController.workflowItem.ID;
            }
        ...
        public override void InitializeComponent()
        {
            ...
            tableView_tasks.ContentInset = new UIEdgeInsets(-30, 0, 0, 0);
        ...
        public override void InitializeFrameView(CGRect frame)
        {
            ...
            view_content.Frame = new CGRect(0, view_header.Frame.Bottom, frame.Width, frame.Height - (view_header.Frame.Height + 40));
            tableView_tasks.Frame = new CGRect(10, 10, view_content.Frame.Width - 20, (view_content.Frame.Height - 10));
            //tableView_tasks.Frame = new CGRect(10, view_header.Frame.Bottom + 10, frame.Width - 20, frame.Height - ((20 + paddingTop) + 10));
        }
        ...
        public override void SetValue()
        {
            ...
            {
                FollowListViewController followListViewController = parentView as FollowListViewController;
                BeanWorkflowItem beanWorkflowItem = followListViewController.workflowItem;
            }
            ...
            tableView_tasks.Source = new Tasks_TableSource(lst_task, this);
