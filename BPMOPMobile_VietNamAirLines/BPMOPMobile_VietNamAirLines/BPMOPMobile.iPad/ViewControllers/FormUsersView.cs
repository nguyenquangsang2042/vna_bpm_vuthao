...
{
    public partial class FormUsersView : UIViewController
    {
        ...
        nfloat width = 0;
        int lines = 1;
        public FormUsersView(IntPtr handle) : base(handle)
        {
        }
        ...
        public override void ViewDidLoad()
        {
            ...
            BT_approve.TouchUpInside += BT_accept_TouchUpInside;
        ...
        private void loadContent()
        {
            ...
            {
                Console.WriteLine("FormUsersView - loadContent - Err: " + ex.ToString());
            }
        }
        ...
        private void loadContentFromRequestAddInfo()
        {
            ...
            FormAdditionalInformationView requestAddInfo = parentView as FormAdditionalInformationView;
        ...
        public void HandleSeclectItem(BeanUser _user, NSIndexPath _indexPath)
        {
            if (!isMultiSelect)
            {
                ...
                {
                    FormWorkFlowDetails formWorkFlowDetails = (FormWorkFlowDetails)parentView;
                    formWorkFlowDetails.HandleUserSingleChoiceSelected(element, currentUserSelected);
                }
                else if (parentView.GetType() == typeof(FollowListViewController))
                {
                    ...
                    followListViewController.HandleUserSingleChoiceSelected(element, currentUserSelected);
                }
        ...
        private void BT_accept_TouchUpInside(object sender, EventArgs e)
        {
            ...
            else if (parentView.GetType() == typeof(ToDoDetailView))
            {
                ...
                toDoDetail.HandleUserMultiChoiceSelected(element, lst_user_select);
            ...
            else if (parentView.GetType() == typeof(FollowListViewController))
            {
                ...
                followListViewController.HandleUserMultiChoiceSelected(element, lst_user_select);
        ...
        private class users_TableSource : UITableViewSource
        {
            ...
            FormUsersView parentView;

            public users_TableSource(List<BeanUser> _user, FormUsersView _parentview)
            {
                parentView = _parentview;
                if (_user != null)
                {
        ...
        {
            FormUsersView parentView { get; set; }
            public static Dictionary<string, List<BeanUser>> indexedSession;
            public List<BeanUser> items;

            public User_CollectionSource(FormUsersView _parentview, List<BeanUser> _items, List<KeyValuePair<string, bool>> _sectionState)
            {
                parentView = _parentview;
                items = _items;
                LoadData();
        ...
        {
            FormUsersView parent;
            User_CollectionSource collectionSource_user;
            nfloat titleWidth = 0, height = 0;
            BeanUser user { get; set; }

            #region Constructors
            public User_CollectionFlowLayoutDelegate(User_CollectionSource _lst_user, FormUsersView _parent)
            {
