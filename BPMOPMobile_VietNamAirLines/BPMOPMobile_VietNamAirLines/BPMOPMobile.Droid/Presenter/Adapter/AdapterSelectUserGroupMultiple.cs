...
{
    public class AdapterSelectUserGroupMultiple : RecyclerView.Adapter
    {
        private MainActivity _mainAct;
        private Context _context;
        private List<BeanUserAndGroup> _lstUser = new List<BeanUserAndGroup>();
        private List<BeanUserAndGroup> _lstClicked = new List<BeanUserAndGroup>();
        public event EventHandler<BeanUserAndGroup> CustomItemClick;

        private ControllerBase CTRLBase = new ControllerBase();
        public AdapterSelectUserGroupMultiple(MainActivity _mainAct, Context _context, List<BeanUserAndGroup> _lstUser, List<BeanUserAndGroup> _lstClicked)
        {
            this._mainAct = _mainAct;
            this._context = _context;
            this._lstUser = _lstUser;
            this._lstClicked = _lstClicked;
        }
        ...
        public void UpdateCurrentList(List<BeanUserAndGroup> _lstUser)
        {
            this._lstUser = _lstUser;
        }
        ...
        public override RecyclerView.ViewHolder OnCreateViewHolder(ViewGroup parent, int viewType)
        {
            ...
            AdapterAdapterSelectUserMultipleViewHolder holder = new AdapterAdapterSelectUserMultipleViewHolder(itemView, OnItemClick);
            return holder;
        }
        public override void OnBindViewHolder(RecyclerView.ViewHolder holder, int position)
        {
            AdapterAdapterSelectUserMultipleViewHolder _holder = holder as AdapterAdapterSelectUserMultipleViewHolder;
    ...
    public class AdapterAdapterSelectUserMultipleViewHolder : RecyclerView.ViewHolder
    {
        ...
        public AdapterAdapterSelectUserMultipleViewHolder(View itemview, Action<int> listener) : base(itemview)
        {
