...
{
    class AdapterDetailChooseUser_Text : RecyclerView.Adapter
    {
        ...
        public AdapterDetailChooseUser_Text(MainActivity _mainAct, Context _context, List<BeanUser> _lstUser)
        {
        ...
        public override RecyclerView.ViewHolder OnCreateViewHolder(ViewGroup parent, int viewType)
        {
            ...
            AdapterDetailChooseUser_TextViewHolder holder = new AdapterDetailChooseUser_TextViewHolder(itemView, OnItemClick);
            return holder;
        }
        public override void OnBindViewHolder(RecyclerView.ViewHolder holder, int position)
        {
            AdapterDetailChooseUser_TextViewHolder _holder = holder as AdapterDetailChooseUser_TextViewHolder;
    ...
    public class AdapterDetailChooseUser_TextViewHolder : RecyclerView.ViewHolder
    {
        public LinearLayout _lnAll { get; set; }
        public TextView _tvName { get; set; }
        public ImageView _imgDelete { get; set; }
        public AdapterDetailChooseUser_TextViewHolder(View itemview, Action<int> listener) : base(itemview)
        {
