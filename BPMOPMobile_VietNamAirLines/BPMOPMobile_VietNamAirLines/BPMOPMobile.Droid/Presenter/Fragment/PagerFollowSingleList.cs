...
{
    public class PagerFollowSingleList : CustomBaseFragment
    {
        ...
        #region Constructor
        public PagerFollowSingleList() { }

        public PagerFollowSingleList(CustomBaseFragment _parentFragment, string _type, List<KeyValuePair<string, string>> _lstFilterCondition)
        {
            this._parentFragment = _parentFragment;
            this._type = _type;
            this._lstFilterCondition = _lstFilterCondition;
        }
        public PagerFollowSingleList(CustomBaseFragment _parentFragment, string _type, List<KeyValuePair<string, string>> _lstFilterCondition, bool isFollowScreen = false)
        {
            this._parentFragment = _parentFragment;
            this._type = _type;
            this._lstFilterCondition = _lstFilterCondition;
        ...
        {
            PagerFollowSingleList fragment = new PagerFollowSingleList(_parentFragment, type, _lstFilterCondition);
            return fragment;
        }
        ...
        {
            PagerFollowSingleList fragment = new PagerFollowSingleList(_parentFragment, type, _lstFilterCondition, isFollowScreen: _isFollowScreen);
            return fragment;
        }
            ...
            try
            {
                ...
                if (_type.ToLowerInvariant().Equals("vdt"))
                {
                    if (CTRLHomePage.CheckListFilterIsDefault_VDT(_lstFilterCondition, true)) // Default Filter -> offline
                    {
                        ...
                        _queryVDT = CTRLHomePage.GetQueryStringAppBaseVDT_ByCondition(_lstFilterCondition, true, false, _orderByColumn: _valueCondition.Equals("1") ? "NOTI.StartDate" : "AB.Modified");
