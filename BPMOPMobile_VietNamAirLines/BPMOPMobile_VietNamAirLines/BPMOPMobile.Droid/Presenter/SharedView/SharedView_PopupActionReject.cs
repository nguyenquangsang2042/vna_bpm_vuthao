...
{
    /// <summary>
    /// Xài cho các Action_Reject_Return_Idea
    /// </summary>
    class SharedView_PopupActionReject : SharedView_PopupActionBase
    {
        private ControllerDetailWorkflow CTRLDetailWorkflow = new ControllerDetailWorkflow();
        public SharedView_PopupActionReject(LayoutInflater _inflater, AppCompatActivity _mainAct, CustomBaseFragment _fragment, string _fragmentTag, View _rootView) : base(_inflater, _mainAct, _fragment, _fragmentTag, _rootView)
        {
                            ...
                            case (int)FlagViewControlAction.DetailWorkflow: // Action Trang Detail Workflow
                                {
                                    ...
                                    _frag.Action_SendAPI(buttonAction, _edtComment.Text, null); // Check xem có comment không
                                    break;
                                }
                        }
                    }
