...
{
    class SharedView_PopupControlMultiLookup : SharedView_PopupControlBase
    {
        public SharedView_PopupControlMultiLookup(LayoutInflater _inflater, AppCompatActivity _mainAct, CustomBaseFragment _fragment, string _fragmentTag, View _rootView) : base(_inflater, _mainAct, _fragment, _fragmentTag, _rootView)
        {
        ...
        public override void InitializeView()
        {
            ...
            try
            {
                ...
                _edtSearch.TextChanged += (sender, e) =>
                {
                    ...
                    AdapterFormControlMultiChoice _adapterFormControlMultiChoice = new AdapterFormControlMultiChoice((MainActivity)base._mainAct, _rootView.Context, _lstSearch);
                    StaggeredGridLayoutManager staggeredGridLayoutManager = new StaggeredGridLayoutManager(1, LinearLayoutManager.Vertical);
                    _recyData.SetAdapter(_adapterFormControlMultiChoice);
                    _recyData.SetLayoutManager(staggeredGridLayoutManager);
                ...
                _imgDone.Click += (sender, e) =>
                {
                    ...
                    if (_lstselected != null && _lstselected.Count > 0)
                    {
                        ...
                        {
                            _lstResult.Add(_lstselected[i].ID);
                            _lstResult.Add(_lstselected[i].Title);
                        }
