...
public class ChildAppVDTFragment extends BaseFragment implements SingleListVDTPresenter.RefreshFilterListener, HomePageVDTAdapter.HomePageRecyVDTListener {
    ...
    public ChildAppVDTFragment() {
        // Required empty public constructor
    }

    public ChildAppVDTFragment(Workflow workflow, SingleListVDTPresenter.PagerSingleListVDTListener listener) {
    ...
    private void setData() {
        appBases = appBaseController.getVDTItems(0, workflow.getWorkflowID());
        if (appBases.size() > 0) {
