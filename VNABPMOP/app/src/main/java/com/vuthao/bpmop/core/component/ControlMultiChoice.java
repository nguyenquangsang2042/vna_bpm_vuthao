...
public class ControlMultiChoice extends ControlBase {
    private final ViewElement _element;
    // Input grid Details
    ...
    public ControlMultiChoice(Activity mainAct, LinearLayout parentView, ViewElement element) {
        super(mainAct);
        this._element = element;
        initializeComponent();
    }

    public ControlMultiChoice(Activity mainAct, LinearLayout parentView, ViewElement elementParent, ViewElement elementChild, JSONObject JObjectChild, int flagView) {
        super(mainAct);
        // Để render theo base
        this._element = elementChild;
    ...
    public void setValue(String value) {
        if (!Functions.isNullOrEmpty(_element.getValue())) {
            ...
            lnContent.setOnClickListener(new MultipleClickGuard(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (JObjectChild != null) {
                        ...
                        intent.putExtra("element", new Gson().toJson(_element));
                    }
    ...
    public void setTitle() {
        ...
        tvTitle.setText(_element.getTitle());
        if (_element.isRequire() && _element.isEnable()) {
