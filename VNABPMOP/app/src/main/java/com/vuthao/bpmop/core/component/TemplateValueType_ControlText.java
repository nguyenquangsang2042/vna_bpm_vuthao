...
public class TemplateValueType_ControlText extends ControlText {
    ...
    public TemplateValueType_ControlText(Activity mainAct, LinearLayout parentView, ViewElement elementParent,ViewElement elementChild, JSONObject JObjectChild, int flagView) {
